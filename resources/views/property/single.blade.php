    ...
    <div class="shadow-md border-2 border-gray-300 py-2 bg-white mt-28">
        <div class="container mx-auto">
            <ul class="flex items-center">
                ...
                <li class="mx-3"><i class="fa fa-angle-right">{{ number_format($property->price, 2, ',', ',') }} TL</i></li>
                <li>{{$property->name}}</li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="flex-1 border-l-2 border-gray-300 ml-3 pl-3 self-center">
                            <ul>
                                ...
                                <li class="flex text-sm">
                                    ...
                                    <span class="ml-2 font-bold">{{$property->beadrooms}}</span>
                                </li>
                            </ul>
                        </div>
                        <div class="flex-1 border-l-2 border-gray-300 ml-3 pl-3 self-center">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-5">
                            <label class="inputLabel" for="email">Email <span
                                    class="text-red-800 font-serif">*</span></label> <br>
